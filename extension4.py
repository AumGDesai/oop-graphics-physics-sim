...
Aum Desai
Fall 2022
CS152B Project Extension_4 07

This program is for Project 07 extension. 
You can run it by putting python3 extension4.py in the terminal.
...
def main():
    ...
    while True:
        ...
        if block.collision( ball):
            ...
            collpos = ball.getVelocity()
            ball.setVelocity(.9* collpos[0],-(.9*collpos[1]))
